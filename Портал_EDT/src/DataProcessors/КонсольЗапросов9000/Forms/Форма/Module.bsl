...
&НаКлиенте
Функция ПоказатьПредупреждениеКонсоли(ТекстПредупреждения) Экспорт
	...
	Для Каждого Колонка Из тзДанные.Колонки Цикл
		...
		Если Колонка.ТипЗначения.СодержитТип(Тип("МоментВремени")) Тогда
			...
			Иначе
				...
				Для Каждого СтрокаДанных Из тзДанные Цикл
					Значение = СтрокаДанных[ИмяКолонки];
					Если ТипЗнч(Значение) = Тип("Момент") Тогда
...
&НаСервере
Функция ЗагрузитьВременнуюТаблицу(ИмяТаблицы, тзДанные, маЗапросыЗагрузки, ЗапросЗагрузкиТаблиц)
